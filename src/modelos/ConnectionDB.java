...
public class ConnectionDB {
    public Connection cadena_conexion(){
        ...
        try{
            ...
            cn = DriverManager.getConnection("jdbc:sqlserver://LAPTOP-2ABUQ2E1;databaseName=directorio;user=sa;password=123456;encrypt=true;trustServerCertificate=true");
